...
class _ProductsServicesScreenState extends State<ProductsServicesScreen> {
  ...
  Future<void> _initializeAndLoadProducts() async {
    ...
    try {
      ...
      if (companies.isEmpty) {
        setState(() {
          _errorMessage = 'No companies found. Please create a company first.';
          _isLoading = false;
        });
        return;
      }
      ...
      setState(() {
        _errorMessage = 'Failed to load company information';
        _isLoading = false;
      });
    }
  }
  ...
  void _showAddProductDialog() async {
    ...
    // Reload products list if something was added
    if (result == true) {
      print('📦 Product added successfully, reloading list...');
      await _loadProducts();
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            ElevatedButton(
                              onPressed: _initializeAndLoadProducts,
