...
void main() => runApp(const StateAdminDashboardApp());

class StateAdminDashboardApp extends StatelessWidget {
  const StateAdminDashboardApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StateAdminDashboardApp(),
    );
  }
}
