...
class _LocationSelectionScreenState extends State<LocationSelectionScreen> {
  ...
  final Map<String, List<String>> blocks = {
    'Chennai': ['North Block', 'South Block', 'Central Block', 'East Block', 'West Block'],
  ...
  void confirmSelection() {
    if (selectedState != null && selectedDistrict != null && selectedBlock != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Location selected: $selectedState, $selectedDistrict, $selectedBlock'),
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: selectedState != null
                              ? districts[selectedState]!.map((String district) {
                                  return DropdownMenuItem<String>(
                                    value: district,
                                    child: Text(district),
                                  );
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: selectedDistrict != null && blocks.containsKey(selectedDistrict)
